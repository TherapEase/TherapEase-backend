...
defaultRoute.post('/segnalazione/:id' ,tokenCheck, segnala, (req:Request,res:Response)=>{
    res.json(req.body)
})

defaultRoute.get('/segnalazione/catalogo_segnalazioni' ,tokenCheck, get_all_segnalazioni, (req:Request,res:Response)=>{
    res.json(req.body)
})
